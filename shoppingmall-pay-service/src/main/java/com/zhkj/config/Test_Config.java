...
//        return ShardingDataSourceFactory.createDataSource(dataSourceMap, shardingRuleConfig, new ConcurrentHashMap(), new Properties());
      return  ShardingDataSourceFactory.createDataSource(new File("F:\\代码\\shopping_mall\\shoppingmall-pay-service\\src\\main\\resources\\sharding-jdbc\\sharding-jdbc.yml.back"));
    }
